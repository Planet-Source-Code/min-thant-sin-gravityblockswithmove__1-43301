...
Public Type GRAVITY_BLOCK
      ...
      'Actual location of the block
       ...
       ShowingHint As Boolean
      'already been found. To avoid repetition.
End Type

Public Const MinBlocksToClick As Byte = 2      'A group of minimum blocks to click to remove them
...
Public boolMovableBlocks As Boolean
Public boolDragging As Boolean
...
Public colHintBlocks As New Collection
