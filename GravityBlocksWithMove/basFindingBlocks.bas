...
Public Sub FindSameBlocks(ByVal Index As Integer, colObject As Collection)
      ...
      If LeftBlock <> -1 Then
            ...
            If Blocks(LeftBlock).HasBeenFound = False Then
                  ...
                  If Blocks(LeftBlock).Number = Blocks(Index).Number Then
                        ...
                        Call colObject.Add(Blocks(LeftBlock).ID, Blocks(LeftBlock).Key)
                        'Find same blocks around this one
                        Call FindSameBlocks(Blocks(LeftBlock).ID, colObject)
                  End If
            End If
      End If
      ...
      If RightBlock <> -1 Then
            If Blocks(RightBlock).HasBeenFound = False Then
                  If Blocks(RightBlock).Number = Blocks(Index).Number Then
                        ...
                        Call colObject.Add(Blocks(RightBlock).ID, Blocks(RightBlock).Key)
                        Call FindSameBlocks(Blocks(RightBlock).ID, colObject)
                  End If
            End If
      End If
      ...
      If TopBlock <> -1 Then
            If Blocks(TopBlock).HasBeenFound = False Then
                  If Blocks(TopBlock).Number = Blocks(Index).Number Then
                        ...
                        Call colObject.Add(Blocks(TopBlock).ID, Blocks(TopBlock).Key)
                        Call FindSameBlocks(Blocks(TopBlock).ID, colObject)
                  End If
            End If
      End If
      ...
      If BottomBlock <> -1 Then
            If Blocks(BottomBlock).HasBeenFound = False Then
                  If Blocks(BottomBlock).Number = Blocks(Index).Number Then
                        ...
                        Call colObject.Add(Blocks(BottomBlock).ID, Blocks(BottomBlock).Key)
                        Call FindSameBlocks(Blocks(BottomBlock).ID, colObject)
                  End If
            End If
      End If
