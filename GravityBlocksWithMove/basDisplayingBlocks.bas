...
Public Sub BlitHint(ByVal Index As Integer)
      
      Call BitBlt(frmPuzzle.picBoard.hDC, _
            Blocks(Index).Left, Blocks(Index).Top, _
            BlockWidth, BlockHeight, _
            frmPuzzle.picHint.hDC, _
            Blocks(Index).Number * BlockWidth, _
             0, _
            vbSrcCopy)
     ...
     ' Call BitBlt(frmPuzzle.picBoard.hDC, _
            Blocks(Index).Left, Blocks(Index).Top, _
            BlockWidth, BlockHeight, _
            frmPuzzle.picFade.hDC, _
             0, _
             Blocks(Index).Number * BlockHeight, _
            vbSrcCopy)
